...
import {addPost, submitPost, cancelPost, editPost, fetchUser} from '../actions/personalPageAction'

@connect((store) => ({
  userInfo: store.userInfo
}),
  {navigateToHomePage, addPost, cancelPost, submitPost, editPost, fetchUser}
)
